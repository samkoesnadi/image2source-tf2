...
if __name__ == "__main__":
    ...
    sxn_string = """html <content> body { div id = " main " { div id = " header " { div id = " logo " { div id = " logo _ text " { h1 { a href = " index . html " { t { asdf } span class = " logo _ colour " { t { asdf } } } } h2 { t { asdf 4 } } } } div id = " menubar " { ul id = " menu " { li class = " selected " { a href = " index . html " { t { asdf } } } li { a href = " examples . html " { t { asdf } } } li { a href = " page . html " { t { asdf 2 } } } li { a href = " another _ page . html " { t { asdf 2 } } } li { a href = " contact . html " { t { asdf 2 } } } } } } div id = " site _ content " { div class = " sidebar " { h3 { t { asdf 2 } } h4 { t { asdf 3 } } h5 { t { asdf 3 } } p { t { asdf 18 } br { } a href = " # " { t { asdf 2 } } } h1 { t { asdf 2 } } ul { li { a href = " # " { t { asdf 2 } } } br { a href = " # " { t { asdf 2 } } } li { a href = " # " { t { asdf 2 } } } li { a href = " # " { t { asdf 2 } } } } h1 { t { asdf } } form method = " post " action = " # " id = " search _ form " { p { input class = " search " type = " text " name = " search _ field " value = " enter keywords . . . . . " { } input name = " search " type = " image " style = " border : 0 ; margin : 0 0 - 9px 5px ; " src = " * * * " alt = " search " title = " search " { } } } } div id = " content " { h1 { t { asdf 5 } } p { t { asdf 14 } } form action = " # " method = " post " { div id = " form _ settings " { } } } } } div id = " your _ footer " contact " type = " text " name = " your _ name " value = " " { } } p { span { t { asdf 2 } } input class = " contact " type = " text " name = " your _ email " value = " " { } } p { span { t { asdf } } textarea class = " contact textarea " rows = " 8 " cols = " 50 " name = " your _ enquiry " { } } p style = " padding - top : 15px " { span { } input class = " submit " type = " submit " name = " contact _ submitted " value = " submit " { } } } } p { br { } br { } t { asdf 19 } } } } div id = " footer " { p { a href = " index . html " { t { asdf } } t { asdf } a href = " examples . html " { t { asdf } } t { asdf } a href = " page . html " { t { asdf 2 } } t { asdf } a href = " another _ page . html " { t { asdf 2 } } t { asdf } a href = " contact . html " { t { asdf 2 } } } a href = " http : / check / jigsaw . w3 . org / check / www . co . org / check / referer " { t { asdf } } t { asdf 3 } } } } } head { title { t { asdf } } } link rel = " http : / check ? uri = " href = " stylesheet " { } } link rel = " stylesheet " type = " text / css " { t { asdf 3 } } <eop> style . css " href = " style . css " { } link rel = " stylesheet " type = " text / css " href = " style . css " { } } <eop> style . css <content> html $ height : 100 % ; & body $ font - serif ; padding : 0 ; & body $ font : normal ` . 80em \' trebuchet ` ms \' , arial , sans - serif ; background : # fff ; color : # f0efe2 ` 20px ` 0 ` url ( pattern . 7em ; line - height : 1 . 7em ; color : # 43423f ; margin : 0 ` 0 ` 15px ` 0 ; color : 1 . 7em ; & p $ font : # 43423f ; color : normal ` 170 % \' century ` gothic \' , arial ; margin : normal ` 0 ` 15px ` 0 ; padding : 10px ` 0 ` 5px ` 0 ; & h2 $ font - serif ; color : # 362c20 ; & h3 $ font : normal ` 125 % \' century ` gothic \' century ` gothic \' , sans - serif ; padding : # b60000 ; padding : 0 ` 0 ` 120 % arial , h6 $ font - serif ; color : 0 ; color : # 000 ; & h5 , sans - serif ; font : hover $ font : italic ` 95 % arial , h6 $ outline : none ; & a : underline ; margin : none ; width : # 362c20 ; width : 1px ` solid ` # e5e5db ; background : # 362c20 ; margin : hover $ float : circle ; width : 10px ` auto ; & blockquote $ display : # e5e5db ; width : auto ; margin - align : 2px ` 17px ; margin : 2px ` li $ margin : auto ; & ol $ float : 0 ; margin : # fff ; width : auto ; & ol ` 0 ` 22px ` 17px ; padding - align : 20px ` 11px ` 0px ; margin : 2px ` 11px ` 11px ` 11px ` 4px ` 11px ` 11px ` 11px ` 11px ` 11px ` 11px ` solid ` 4px ` 11px ` li $ margin : 8px ` 11px ` 11px ` 11px ` 11px ` 0 ` 22px ` 6px ` 11px ` 0 ` 11px ` li $ list - style - left : circle ; margin - left : auto ; & ol ` 11px ` 6px ` 0 ; margin - right : 0px ` 11px ` # main , # fff ; height : auto ; & # logo , # logo _ text - bottom : absolute ; height : 0 ; height : relative ; height : absolute ; height : absolute ; position : 0 ; height : absolute ; & # logo ` h1 , # logo ` h2 $ font - bottom : # fff ; height : absolute ; height : transparent ; height : # fff ; height : 0 ; height : # logo _ text ` h2 $ padding - transform : none ; & # logo _ text - size : url ( logo _ text ` h2 $ width : absolute ; margin : - serif ; border : none ; width : # fff ; background : # fff ; color : 0 . 1em ; height : # logo _ text - size : none ; & # logo _ colour $ color : # fff ; height : 0 ; height : # fff ; & # logo ` h2 $ font : 100 % \' , arial , # menu ` h2 , # bbb ; height : none ; background : 0 ; & # menu $ font - bottom : 0 ; & # logo _ text ` h1 , # menu ` a , ul # menu , ul # menu , ul # menu ` a : # menu"""

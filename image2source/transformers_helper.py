...
from image2source.common_definitions import KERNEL_INITIALIZER, ACTIVATION, MAX_SEQ_LEN_DATASET
...
class Encoder(tf.keras.layers.Layer):
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size,
        ...
        self.intermediate_embedding = tf.keras.layers.Dense(d_model + (1280 - d_model) // 2,
...
class Decoder(tf.keras.layers.Layer):
    ...
    def call(self, x, enc_output, training,
        ...
        if decode_pos is None:
            ...
            x += tf.map_fn(lambda pos_x: self.pos_encoding[pos_x:seq_len + pos_x, :], decode_pos,
                           dtype=tf.float32)
